...
while(1)
{
val=read_time(0); time[5]=(char)un(val)+48; time[6] =(char)ln(val);
val=read_time(1); time[8]=(char)un(val)+48; time[9]=(char)ln(val);
val=read_time(2); time[11]=(char)un(val)+48; time[12] =(char)ln(val);
val=read_time(4); date[5]=(char)un(val)+48; date[6]=(char)ln(val);
val=read_time(5); date[8]=(char)un(val)+48; date[9] =(char)ln(val);
val=read_time(6); date[11]=(char)un(val)+48; date[12]=(char)ln(val);
